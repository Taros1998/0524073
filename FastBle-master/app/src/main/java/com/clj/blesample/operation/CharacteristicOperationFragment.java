        ...
        if (childList.contains(child)) {
            ...
            switch (charaProp) {
                ...
                case PROPERTY_WRITE: {
                    ...
                    // go button test
                    ImageButton go_btn = (ImageButton) view.findViewById(R.id.go_btn);
                    ImageButton down_btn = (ImageButton) view.findViewById(R.id.down_btn);
                    ImageButton left_btn = (ImageButton) view.findViewById(R.id.left_btn);
                    ImageButton right_btn = (ImageButton) view.findViewById(R.id.right_btn);
                    ImageButton back_right = (ImageButton) view.findViewById(R.id.back_right);
                    ImageButton back_left = (ImageButton) view.findViewById(R.id.back_left);

                    //hex = "";
                    go_btn.setOnTouchListener(new View.OnTouchListener() {
                        @Override
